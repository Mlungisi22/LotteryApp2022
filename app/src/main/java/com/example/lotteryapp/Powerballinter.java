...
public class Powerballinter extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_powerballinter);
        ...
        TextView num6=(TextView)findViewById(R.id.results21);
        TextView [] Thenumbers={num1,num2,num3,num4,num5,num6};
